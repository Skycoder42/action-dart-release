...
fs_1.promises.readFile = jest.fn();
fs_1.promises.writeFile = jest.fn();
...
const readFileMock = utils_1.mocked(readFile, true);
const writeFileMock = utils_1.mocked(writeFile, true);
